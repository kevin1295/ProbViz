...
from qfluentwidgets import (
    FlowLayout, Slider, CompactDoubleSpinBox, CompactSpinBox
)
    ...
    class ExpInterface(QWidget):
        ...
        class PlotWidget(QWidget):
            ...
            def update_plot(self, n=None, p=None):
                ...
                ax.set_xlabel('$k$')
                ax.set_ylabel('$P(X=k)$')
                ax.set_title(f'二项分布 $B(n={n}, p={p})$ 的概率质量函数')
        ...
        def __init__(self, parent=None):
            ...
            # 标题
            self.title = MarkdownKaTeXWidget(self)
            self.title.set_markdown("## 二项分布")
